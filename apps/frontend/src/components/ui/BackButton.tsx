...
export function BackButton({ className }: BackButtonProps) {
  ...
  return (
    <button
      ...
      onClick={() => navigate(-1)}
      className={cn(
        'inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-surface-2 text-text-secondary transition-colors hover:bg-surface-hover hover:text-text-primary',
        className,
      )}
    >
