...
/**
 * Renders one of the fixed, staff-pickable icons for the player app's second
 * navbar from shared geometry (packages/shared/src/domain/topNavIcons.ts) -
 * mirrors the frontend's TopNavIcon so the CMS picker previews exactly what
 * players will see (20x20 viewBox, currentColor, strokeWidth 1.6, round
 * caps/joins).
 */
