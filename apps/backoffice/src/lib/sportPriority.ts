/** These three, in this order, always lead sport listings when present; everything else follows in the order it was first seen. Mirrors apps/frontend's lib/sportPriority.ts - small enough not to warrant a shared package. */
