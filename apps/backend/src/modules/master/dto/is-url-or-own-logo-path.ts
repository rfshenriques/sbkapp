...
/**
 * A brand's logo*Url fields are either a staff-pasted external URL, or the
 * relative path BrandsService.setLogo writes after an upload
 ...
 */
const OWN_LOGO_PATH = /^\/backend\/public\/brands\/[^/]+\/logo\/(SITE|SHARE)_(LIGHT|DARK)$/;
